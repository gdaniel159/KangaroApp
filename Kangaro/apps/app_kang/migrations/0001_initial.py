    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_experiencia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_kang.experiencialaboral')),
                ('id_formacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_kang.formacionacademica')),
                ('id_usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_kang.usuario')),
            ],
        ),
        migrations.CreateModel(
