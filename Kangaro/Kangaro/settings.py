"""
Django settings for Kangaro project.
...
SECRET_KEY = 'django-insecure-8_vm98(=(m@yx8vfktlmy$w(5*%r6qd1!sb#_d0la*c426n$kx'
...
WSGI_APPLICATION = 'Kangaro.wsgi.application'
